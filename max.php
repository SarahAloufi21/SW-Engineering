        ...
        <div class="row g-md-5">
                ...
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/max.jpeg" class="img-fluid" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/max.jpeg" class="img-fluid" />
                    </div>
          ...
          <div class="col-lg-6 mt-5 ">
            <div class="product-info">
              ...
              <div>
              <ul> <h5> PetID :U8359 </h5> </ul>
              <ul> <h5> Name :Max </h5> </ul>
              <ul><h5> Gender : Male </h5></ul>
              <ul><h5> Pet Type : Cat </h5></ul>
              <ul><h5>Breed : persian cat</h5>  </ul>
              <ul> <h5>Age: 2 month</h5> </ul>
              <ul> <h5>City: Riyadh </h5> </ul>
              <ul> <h5 >Health : no Vaccinations </h5></ul>
              <Ul><h5> CHARACTERISTICS : Friendly, Gentle, love playing with toys</h5></Ul> 
            </div>  
