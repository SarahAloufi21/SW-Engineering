        ...
        <div class="row g-md-5">
                ...
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/bob.jpg" class="img-fluid" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/bob.jpg" class="img-fluid" />
                    </div>
          ...
          <div class="col-lg-6 mt-5 ">
            <div class="product-info">
              ...
              <div>
                <ul> <h5> PetID :VUI34 </h5> </ul>
              <ul> <h5> Name :Bob </h5> </ul>
              <ul><h5> Gender : Male</h5></ul>
              <ul><h5> Pet Type : Dog </h5></ul>
              <ul><h5>Breed : french bullDog</h5>  </ul>
              <ul> <h5>Age:  3 years</h5> </ul>
              <ul> <h5>City: Riyadh </h5> </ul>
              <ul> <h5 >Health : Vaccinations up to day </h5></ul>
              <Ul><h5> CHARACTERISTICS : Playful, Smart, not Dog Friendly Kid Friendly</h5></Ul> 
            </div>  
