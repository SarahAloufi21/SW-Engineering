...
<head>
  ...
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.css">
  <style>
    .close-button {
      cursor: pointer;
    }
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-dark">
    <div class="container">
          <span class="navbar-text text-white-50 ">
            WELLCOME! 🎉 Share Your Experience and Rate Us🌟!
          </span>
      <a href="customerExperiences.php" class="btn btn-danger ml-3">Share Now</a>
      <span class="close-button ml-3 text-white">X</span>
    </div>
  </nav>
  ...
  <section id="banner" class="py-3" style="background: #F9F3EC;">
        <div class="container py-5 my-3">
            <div class="hero-content py-5 my-3">
                <h2 class="display-1 mt-3 mb-0">Adoption <span class="text-primary"> </span></h2>
  ...
  <section id="pets">
    <div class="adopt-grid">
        <div class="container py-3 my-3">
          <div class="row flex-md-row-reverse g-md-3 mb-3">
            ...
            <main class="col-md-9">
              <div class="product-grid row ">
                <div class="col-md-4 my-4">
                  ...
                  <div class="card position-relative">
                    <a href="leo.php"><img src="images/cat1.jpeg" class="img-fluid rounded-4" alt="image"></a>
                    <div class="card-body p-0">
                      <a href="leo.php">
                        <h3 class="card-title pt-4 m-0">leo </h3>
                        <h5 class="secondary-font text-primary">american cat </h5>
                      </a>
                ...
                <div class="col-md-4 my-4">
                  <div class="card position-relative">
                    <a href="max.php"><img src="images/cat2.jpeg" class="img-fluid rounded-4" alt="image"></a>
                    <div class="card-body p-0">
                      <a href="max.php">
                        <h3 class="card-title pt-4 m-0">max</h3>
                        <h5 class="secondary-font text-primary">persian cat</h5>
                      </a>                        
                  </div>
              ...
              <div class="col-md-4 my-4">
                <div class="card position-relative">
                  <a href="cloudy.php"><img src="images/cat3.jpeg" class="img-fluid rounded-4" alt="image"></a>
                  <div class="card-body p-0">
                    <a href="cloudy.php">
                      <h3 class="card-title pt-4 m-0">cloudy</h3>
                      <h5 class="secondary-font text-primary">burmese cat</h5>
                    </a>                        
                 </div>
                </div>
              </div>
              ...
              <div class="col-md-4 my-4">
                <div class="card position-relative">
                  <a href="abby.php"><img src="images/dog1.jpeg" class="img-fluid rounded-4" alt="image"></a>
                  <div class="card-body p-0">
                    <a href="abby.php">
                      <h3 class="card-title pt-4 m-0">abby</h3>
                      <h5 class="secondary-font text-primary">Maltese dog</h5>
                    </a>                        
                 </div>
                </div>
              </div>
              ...
              <div class="col-md-4 my-4">
                <div class="card position-relative">
                  <a href="Bob.php"><img src="images/dog2.jpeg" class="img-fluid rounded-4" alt="image"></a>
                  <div class="card-body p-0">
                    <a href="Bob.php">
                      <h3 class="card-title pt-4 m-0">Bob</h3>
                      <h5 class="secondary-font text-primary"> french pulldog dog</h5>
                    </a>                        
                 </div>
                </div>
              </div>
              ...
              <div class="col-md-4 my-4">
                <div class="card position-relative">
                  <a href="lily.php"><img src="images/dog3.jpg" class="img-fluid rounded-4" alt="image"></a>
                  <div class="card-body p-0">
                    <a href="lily.php">
                      <h3 class="card-title pt-4 m-0">lily</h3>
                      <h5 class="secondary-font text-primary"> Weimaraner dog</h5>
                    </a>                        
                 </div>
                </div>
              </div>
        ...
        <aside class="col-md-3 mt-5">
          <div class="sidebar">
              ...
              <div class="widget-search-bar">
                <div class="search-bar border rounded-2 border-dark-subtle pe-3">
                  <form id="search-form" class="text-center d-flex align-items-center" action="" method="">
                    <input type="text" class="form-control border-0 bg-transparent" placeholder="Search for a Pet" />
            ...
            <div class="widget-pet-categories pt-5">
              <h4 class="widget-title">Categories</h4>
              <ul class="pet-categories sidebar-list list-unstyled">
                <li class="pet-type">
                  <a href="adoption.php">All</a>
                </li>
                <li class="pet-type">
            ...
            <div class="widget-pet-categories pt-5">
                ...
                <ul class="product-categories sidebar-list list-unstyled">
                  ...
                  <li class="cities">
                    <a href="#" class="nav-link">Makkah</a>
                  </li>
                  <li class="cities">
                    <a href="#" class="nav-link">Jeddah</a>
                  </li>
                  <li class="cities">
                    <a href="#" class="nav-link">Riyadh</a>
                  </li>
                </ul>
              </div>
