...
<head>
  <title>Joyful Paws | Vaccination service</title>
  <meta charset="utf-8">
  ...
  <section id="banner" class="py-3" style="background: #F9F3EC;">
    <div class="container">
      <div class="hero-content py-5 my-3">
        <h2 class="display-1 mt-3 mb-0">Vaccinations<span class="text-primary"> Service</span></h2>
        <nav class="breadcrumb">
          ...
          <span class="breadcrumb-item active" aria-current="page">Vaccinations Service</span>
        </nav>
      </div>
    </div>
  </section>
              ...
              <div class="swiper product-large-slider">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="images/vaccines4.jpg" class="img-fluid" />
                  </div>
                  <div class="swiper-slide">
                    <img src="images/vaccines2.jpg" class="img-fluid" />
                  </div>
                  <div class="swiper-slide">
                    <img src="images/vaccines3.jpg" class="img-fluid" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-6 mt-5 ">
          <div class="product-info">
            <div class="element-header">
              <!---------------------------------------Form section---------------------------------------------------->
              <h2 itemprop="name" class="display-6">Disease Prevention</h2>
            </div>
            <div class="product-price pt-3 pb-3">
              <strong class="text-primary display-6 fw-bold">185.50 SAR</strong><del class="ms-2"></del>
            ...
            <p>Protect your furry friend from preventable diseases with our vaccination services.
              From routine vaccinations to tailored vaccine schedules, we prioritize your pet's health
              by administering safe and effective vaccines in accordance with recommended guidelines.
            </p>
            ...
            <form action="sarahInsert.php" method="post">
              ...
              <div class="form-group mb-3">
                <button type="submit" class="btn btn-primary" name="VacToDB" id="bookBtn"> Book </button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row align-items-start gap-5">
          ...
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade active show" id="v-pills-description" role="tabpanel"
              ...
              <h2>Pet Vaccination Process</h2>
              <p>During a vaccination appointment, a veterinarian administers a vaccine,
                typically through an injection. Vaccines contain weakened or killed forms
                of disease-causing agents, or antigens, which prompt the pet's immune system
                to recognize and develop defenses against those agents.</p>
            </div>
            <div class="tab-pane fade" id="v-pills-additional" role="tabpanel" aria-labelledby="v-pills-additional-tab"
              ...
              <dl style="list-style-type:disc;" class="list-unstyled ps-4">
                ...
                <dt><b>Update Information:</b></dt>
                <dd>Inform the vet of any changes in health or lifestyle.</dd>
                <dt><b>Ask Questions:</b></dt>
                <dd>Seek clarification on vaccines and schedules.</dd>
                <dt><b>Monitor:</b></dt>
                <dd>Watch for any side effects post-vaccination.</dd>
              </dl>
              <p>
