  ...
  <section id="banner" class="py-3" style="background: #F9F3EC;">
    <div class="container py-5 my-3">
      <div class="hero-content py-5 my-3">
        <h2 class="display-1 mt-3 mb-0"><P></P>Adoption <span class="text-primary"> Information</span> </h2>
      </div>
    </div>
  </section>
    ...
    <section id="selling-product">
      <div class="container my-md-5 py-5">
        <div class="row g-md-5">
                ...
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/leo1.webp" class="img-fluid" />
                    </div>
                    <div class="swiper-slide">
          ...
          <div class="col-lg-6 mt-5 ">
            <div class="product-info">
              <div class="element-header">
                <h2 itemprop="name" class="text-primary">About</h2>
              </div>
              <div>
              <ul> <h5> PetID :BB4085 </h5> </ul>
              <ul> <h5> Name :leo </h5> </ul>
              <ul><h5> Gender : Male </h5></ul>
              <ul><h5> Pet Type : Cat </h5></ul>
              <ul><h5>Breed : American shorthair cat</h5>  </ul>
              <ul> <h5>Age: 2 years</h5> </ul>
              <ul> <h5>City: Jeddah </h5> </ul>
              <ul> <h5 >Health : Vaccinations up to date, spayed / neutered </h5></ul>
              <Ul><h5> CHARACTERISTICS : Friendly, Affectionate, Gentle, Quiet</h5></Ul> 
            </div>  
          ...
          <div class="container">
           <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 py-2 px-4" onclick="showForm()"> Adopt me now </a>
          </div>
    ...
    <input type="submit" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 py-2 px-4" value="Submit">
  </form>
          </div>
        </div>
      </div>
