        ...
        <div class="row g-md-5">
                ...
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/abby.png" class="img-fluid" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/abby.png" class="img-fluid" />
                    </div>
          ...
          <div class="col-lg-6 mt-5 ">
            <div class="product-info">
              ...
              <div>
                <ul> <h5> PetID :A345 </h5> </ul>
              <ul> <h5> Name :Abby </h5> </ul>
              <ul><h5> Gender : Female </h5></ul>
              <ul><h5> Pet Type : Dog </h5></ul>
              <ul><h5>Breed : Maltese Dog</h5>  </ul>
              <ul> <h5>Age:  5 month</h5> </ul>
              <ul> <h5>City: Jeddah </h5> </ul>
              <ul> <h5 >Health : Vaccinations up to day </h5></ul>
              <Ul><h5> CHARACTERISTICS : Playful, Smart, Dog Friendly Kid Friendly</h5></Ul> 
            </div>  
