...
<head>
  <title>Joyful Paws | Wounds treatment service</title>
  <meta charset="utf-8">
  ...
  <section id="banner" class="py-3" style="background: #F9F3EC;">
    <div class="container">
      <div class="hero-content py-5 my-3">
        <h2 class="display-1 mt-3 mb-0">Wounds treatment<span class="text-primary"> Service</span></h2>
        <nav class="breadcrumb">
          ...
          <span class="breadcrumb-item active" aria-current="page">Wounds treatment Service</span>
        </nav>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-6 mt-5 ">
          <div class="product-info">
            <div class="element-header">
              <!---------------------------------------Form section---------------------------------------------------->
              <h2 itemprop="name" class="display-6">Injury Care</h2>
            </div>
            <div class="product-price pt-3 pb-3">
              <strong class="text-primary display-6 fw-bold">150.00 SAR</strong><del class="ms-2"></del>
            ...
            <p>When accidents happen, trust our skilled veterinarians to provide expert wound treatment for your pet.
              Whether it's a minor scrape or a more serious injury, we offer compassionate care and advanced treatments
              to promote healing and minimize discomfort for your beloved companion.
            </p>
            ...
            <form action="sarahInsert.php" method="post">
              ...
              <div class="form-group mb-3">
                <button type="submit" class="btn btn-primary" name="WTToDB" id="bookBtn"> Book </button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row align-items-start gap-5">
          ...
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade active show" id="v-pills-description" role="tabpanel"
              ...
              <h2>Pet's Wound Treatment Process</h2>
              <p>When your furry friend sustains an injury, prompt and proper wound treatment
                can expedite healing and prevent complications.
                <br>Here's what you can expect from a professional wound treatment service for pets:
              </p>
              <ul style="list-style-type:disc;" class="list-unstyled ps-4">
                <li><b>Assessment:</b> We conduct a thorough examination to evaluate the wound's type, size, and
                  severity.</li>
                <li><b>Cleaning and Debridement:</b> We gently clean and remove damaged tissue to promote healing.</li>
                <li><b>Antiseptic Application:</b> We apply safe and effective antiseptics to prevent infection.</li>
                <li><b>Dressing Application: </b> Depending on the wound, we apply a protective dressing for healing.
                </li>
                <li><b>Medication Administration:</b> We administer medications to manage pain and infection as needed.
                </li>
                <li><b>Monitoring and Follow-Up: </b> We closely monitor your pet's progress and schedule follow-up
                  appointments for adjustments.</li>
              </ul>
              <p>With our dedicated team, your pet receives the best care for a speedy recovery.</p>
            </div>
            <div class="tab-pane fade" id="v-pills-additional" role="tabpanel" aria-labelledby="v-pills-additional-tab"
              ...
              <dl style="list-style-type:disc;" class="list-unstyled ps-4">
                ...
                <dt><b>Home Care:</b></dt>
                <dd> Follow wound care instructions diligently.</dd>
                <dt><b>Monitor: </b></dt>
                <dd> Watch for signs of infection and contact us if concerned.</dd>
                <dt><b>Activity Limitation:</b></dt>
                <dd> Restrict activity per our guidance.</dd>
                <dt><b>Medication Compliance: </b></dt>
                <dd> Administer medications as prescribed.</dd>
                <dt><b>Follow-Up: </b></dt>
                <dd> Attend all scheduled appointments for monitoring and adjustments.</dd>
              </dl>
              <p>
