        ...
        <div class="row g-md-5">
                ...
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/lily.webp" class="img-fluid" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/lily.webp" class="img-fluid" />
                    </div>
          ...
          <div class="col-lg-6 mt-5 ">
            <div class="product-info">
              ...
              <div>
              <ul> <h5> PetID :MN112 </h5> </ul>
              <ul> <h5> Name :Lily </h5> </ul>
              <ul><h5> Gender : Female</h5></ul>
              <ul><h5> Pet Type : Dog </h5></ul>
              <ul><h5>Breed : Weimaraner Dog</h5>  </ul>
              <ul> <h5>Age:  5 years</h5> </ul>
              <ul> <h5>City: Riyadh </h5> </ul>
              <ul> <h5 >Health : Vaccinations up to day </h5></ul>
              <Ul><h5> CHARACTERISTICS :Quiet, Playful, Smart,Dog Friendly Kid Friendly</h5></Ul> 
            </div>  
